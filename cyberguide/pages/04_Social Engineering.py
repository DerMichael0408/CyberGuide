...
# Adding missing CSS styles for the social engineering page
social_engineering_css = """
<style>
    /* Social Engineering Specific Styles */
    .scenario-title {
        font-size: 24px;
        font-weight: bold;
        margin-bottom: 15px;
...
# Apply the custom CSS for social engineering page
st.markdown(social_engineering_css, unsafe_allow_html=True)
